      ...
      <div class="w-full">
          ...
          <div class="flex justify-between h-16 items-center">
              ...
              <div class="flex items-center flex-shrink-0 pl-4 xl:pl-6">
                  <NuxtLink to="/" class="flex-shrink-0 flex items-center group relative">
                      ...
                      <div class="flex items-center space-x-1 whitespace-nowrap w-full justify-center transition-all duration-500 ease-in-out"
                          ...
                          <template v-for="(menu, index) in menus" :key="index">
                              <template v-if="!(menu.title === 'DIP' && (!menu.children || menu.children.length === 0)) && menu.title !== 'Login'">
                                  <NuxtLink v-if="!menu.children || menu.children.length === 0" 
                                      :to="menu.url"
                                  ...
                                  <div v-else class="relative flex-shrink-0">
                                      ...
                                      <transition
                                          ...
                                          <div v-show="activeSubMenu === index"
                                              ...
                                              <div class="py-1">
                                                  <NuxtLink v-for="(child, childIndex) in menu.children" :key="childIndex"
                                                      :to="child.url"
                          ...
                          <transition
                              ...
                              <div v-show="activeSubMenu === 'user'"
                                  ...
                                  <div class="py-1">
                                      ...
                                      <NuxtLink v-if="authStore.user?.role === 'superadmin'" to="/admin/dashboard"
          ...
          <template v-if="authStore.isAuthenticated">
              <div class="pt-4 pb-3 border-t border-gray-200">
                  ...
                  <div class="mt-3 space-y-1">
                      <NuxtLink to="/profile" @click="open = false"
                          class="block px-4 py-2 text-base font-medium text-gray-500 hover:text-gray-800 hover:bg-gray-100">
                          Profile
                      </NuxtLink>
                      <NuxtLink v-if="authStore.isAdmin" to="/admin/dashboard" @click="open = false"
                          class="block px-4 py-2 text-base font-medium text-gray-500 hover:text-gray-800 hover:bg-gray-100">
                          Admin Dashboard
                      </NuxtLink>
                      <button @click="handleLogout"
