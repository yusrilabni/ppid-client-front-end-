              ...
              <div id="footer-nav-section">
                  ...
                  <ul class="space-y-2 text-sm text-gray-400">
                      <li v-for="(link, index) in navLinks" :key="index">
                          <NuxtLink :to="link.url" class="hover:text-white">{{ link.title }}</NuxtLink>
                      </li>
                      <li class="pt-2 mt-2 border-t border-gray-800"></li>
                      <li>
                          <NuxtLink to="/kebijakan-privasi" class="hover:text-white flex items-center group">
                      ...
                      <li>
                          <NuxtLink to="/rss" class="hover:text-white flex items-center group">
                      ...
                      <li>
                          <NuxtLink to="/widget" class="hover:text-white flex items-center group">
