import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, getCurrentInstance, inject, getCurrentScope, ref, reactive, effectScope, isRef, isReactive, toRaw, onScopeDispose, watch, nextTick, toRefs, markRaw, computed, defineComponent, createElementBlock, shallowRef, provide, cloneVNode, h, defineAsyncComponent, unref, shallowReactive, createApp, isVNode, createCommentVNode, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, mergeProps, toRef, withCtx, Suspense, Fragment, isReadonly, useSSRContext, isShallow } from 'vue';
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DuB2_1Xh.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DQuiseRQ.mjs'));
...
export { _export_sfc as _, useRoute as a, useNuxtApp as b, useRuntimeConfig as c, nuxtLinkDefaults as d, entry_default as default, encodeRoutePath as e, defineStore as f, navigateTo as n, resolveRouteObject as r, tryUseNuxtApp as t, useRouter as u };
