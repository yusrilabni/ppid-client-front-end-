                ...
                <template v-else-if="surveys.length > 0">
                    <div v-for="survey in surveys" :key="survey.id" class="border-b border-gray-200 pb-6 mb-6 last:border-0 last:mb-0 last:pb-0">
                        ...
                        <div class="flex items-center space-x-4">
                            <NuxtLink :to="'/survei/' + survey.slug" class="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 md:text-lg transition duration-150 ease-in-out">
