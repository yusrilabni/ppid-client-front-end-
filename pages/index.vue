      ...
      <div v-if="homeData.sliders && homeData.sliders.length > 0" class="swiper hero-slider relative w-full overflow-hidden">
        <div class="swiper-wrapper">
          <div v-for="slider in homeData.sliders" :key="slider.id" class="swiper-slide relative">
            <NuxtLink :to="slider.link || (slider.informasi ? `/informasi/${slider.informasi.slug}` : '#')" class="block w-full h-full">
                ...
                <div v-for="info in homeData.latest_informasi" :key="info.id" class="swiper-slide !h-auto p-2 flex">
                  <div :class="['w-full bg-white rounded-3xl border-l-4 shadow-sm hover:shadow-2xl transition-all duration-500 h-full flex flex-col group/card p-6 hover:-translate-y-2 relative overflow-hidden', getCardTheme(info.category).border]">
                    ...
                    <div class="mt-auto pt-5 border-t border-gray-50 flex items-end justify-between relative z-10">
                      ...
                      <NuxtLink :to="`/informasi/detail/${info.slug}`" :class="['w-11 h-11 rounded-2xl bg-gray-900 text-white flex items-center justify-center transition-all shadow-lg active:scale-90 group/btn', getCardTheme(info.category).bg600Hover]">
      ...
      <section id="informasi" class="py-3 md:py-6 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="h-full w-full">
                  <div class="bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 h-full flex flex-col group border border-gray-100 overflow-hidden relative">
                    ...
                    <div class="mt-auto p-5 pt-3 relative z-10 bg-white rounded-b-3xl">
                      <NuxtLink :to="item.url" :class="['w-full py-2.5 px-4 rounded-xl text-white font-bold text-center flex items-center justify-center shadow-md hover:shadow-lg transition-all duration-300 transform group-hover:-translate-y-1 text-sm', getColorStyles(item.color, 'bgGradient')]">
                        Akses Informasi
          ...
          <div class="mt-3 md:mt-6 text-center">
            <NuxtLink :to="authStore.isAuthenticated ? '/permohonan/create' : '/login?redirect_to=/permohonan/create'" class="inline-flex items-center justify-center px-6 py-2 md:px-8 md:py-3 border border-transparent text-sm md:text-base font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700">
      ...
      <section id="galeri" class="py-3 md:py-6 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div class="text-center mt-6 md:mt-8">
            <NuxtLink to="/galeri" class="inline-flex items-center justify-center px-4 py-2 border border-gray-300 text-xs md:text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">
              Lihat Semua Galeri
            </NuxtLink>
          </div>
        </div>
              ...
              <div class="mt-6 md:mt-8 p-5 md:p-6 bg-blue-50 rounded-lg border border-blue-100">
                ...
                <div class="space-y-2 text-xs md:text-sm text-gray-700">
                  ...
                  <p class="flex justify-between text-red-600 font-medium">
                    <span>Jumat (WFH):</span>
                    <span class="bg-red-100 px-2 rounded">08:00 - 16:00 WITA</span>
                  </p>
                  <p class="flex justify-between text-red-600 font-medium">
