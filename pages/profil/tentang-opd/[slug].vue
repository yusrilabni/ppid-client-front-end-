    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <template v-if="!loading">
        <div v-if="error || !organization" class="min-h-screen flex flex-col items-center justify-center bg-gray-50">
          ...
          <NuxtLink to="/profil/tentang-opd" class="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">
        ...
        <div class="mt-12 text-center">
            <NuxtLink to="/profil/tentang-opd" class="inline-flex items-center gap-2 text-gray-500 hover:text-blue-600 font-black text-xs uppercase tracking-widest transition-colors">
