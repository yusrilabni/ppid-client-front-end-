      ...
      <div class="flex flex-col lg:flex-row gap-8">
        ...
        <div class="lg:w-2/3 space-y-12">
                ...
                <div v-for="(item, index) in informasiResults" :key="item.id" class="relative group">
                  ...
                  <div :class="[
                      ...
                      <div class="relative z-10">
                          ...
                          <NuxtLink :to="getInformasiUrl(item)" class="block mb-4">
                      ...
                      <div class="mt-auto pt-5 border-t border-gray-50 flex items-center justify-between relative z-10">
                          ...
                          <NuxtLink :to="getInformasiUrl(item)" 
            ...
            <section v-if="standarLayananResults.length > 0" class="pt-6">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div v-for="item in standarLayananResults" :key="item.id" class="bg-white p-6 rounded-[2rem] border border-gray-100 hover:border-green-300 hover:shadow-xl transition-all duration-500 group/sl shadow-sm overflow-hidden relative flex flex-col">
                  ...
                  <NuxtLink :to="`/standar-layanan/file/${item.slug}`" class="block relative z-10 h-full flex flex-col">
          ...
          <div v-else-if="searched" class="bg-white py-20 px-6 rounded-[3rem] border-2 border-dashed border-gray-200 text-center shadow-inner">
              ...
              <div class="mt-10">
                  <NuxtLink to="/" class="px-8 py-3 bg-blue-600 text-white text-xs font-black uppercase tracking-widest rounded-2xl hover:bg-blue-700 transition-all shadow-lg shadow-blue-200">Kembali ke Beranda</NuxtLink>
              </div>
          </div>
        </div>
          ...
          <section v-if="orgResults.length > 0">
              ...
              <div class="space-y-4">
                  <div v-for="item in orgResults" :key="item.id" class="bg-white p-4 rounded-2xl border border-gray-100 hover:border-purple-300 hover:shadow-xl transition-all duration-500 group/opd shadow-sm">
                      <NuxtLink :to="`/profil/tentang-opd/${item.slug}`" class="flex items-center">
