              ...
              <div class="p-6 sm:p-10">
                ...
                <div v-if="item.related_informasis?.length" class="mt-16 pt-12 border-t border-gray-100">
                  ...
                  <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <NuxtLink v-for="related in item.related_informasis" :key="related.id" :to="`/informasi/detail/${related.slug}`" class="group flex items-center p-4 bg-gray-50 hover:bg-white border border-transparent hover:border-blue-100 rounded-2xl transition-all duration-300 shadow-sm hover:shadow-md">
            ...
            <div class="sticky top-24 space-y-6">
              <div class="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm">
                ...
                <div class="space-y-8">
                  ...
                  <NuxtLink :to="`/informasi/${getCategorySlug(item.category)}`" class="flex items-center justify-center w-full py-4 bg-slate-900 text-white font-bold rounded-2xl text-xs hover:bg-black transition-all">
