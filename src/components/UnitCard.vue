      ...
      <div class="p-8 flex-grow flex flex-col">
          ...
          <div class="mt-auto space-y-3">
              <template v-if="unit.slug">
                  <router-link :to="`/dipunit/dip/${unit.slug}`" :class="[colors.btnBg, colors.btnBgHover, colors.btnShadow, colors.btnShadowHover, 'inline-flex items-center justify-center text-white font-bold py-3 px-6 rounded-xl transition-all duration-300 w-full shadow-lg']">
