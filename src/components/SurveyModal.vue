    ...
    <div v-if="isVisible" class="fixed bottom-6 right-6 z-[99999] w-80 sm:w-96 bg-white rounded-2xl shadow-[0_10px_40px_-10px_rgba(0,0,0,0.3)] overflow-hidden border border-gray-100 flex flex-col">
      ...
      <div class="p-5">
        ...
        <div class="flex items-center gap-3">
          ...
          <router-link :to="{ name: 'survei' }" @click="closeModal" class="flex-1 px-4 py-2.5 bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold rounded-xl text-center shadow-lg shadow-blue-200 transition-all hover:-translate-y-0.5">
            Isi Sekarang
          </router-link>
        </div>
      </div>
