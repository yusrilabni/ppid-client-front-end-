              ...
              <div v-for="official in group.items" :key="official.id" class="group h-full bg-white rounded-[2.5rem] shadow-md hover:shadow-2xl border border-gray-100 overflow-hidden flex flex-col transition-all duration-500 hover:-translate-y-2 relative">
                ...
                <div class="p-8 pb-8 flex flex-col items-center text-center flex-grow relative z-10">
                  ...
                  <div class="min-h-[4rem] flex items-center justify-center mb-2">
                    <router-link :to="`/profil/${official.slug}`" :class="`text-xl md:text-2xl font-black text-gray-900 ${group.hoverText} transition-colors leading-tight line-clamp-2`">
                      {{ official.full_name }}
                    </router-link>
                  </div>
                  ...
                  <div class="mt-auto w-full">
                    ...
                    <div class="space-y-3 w-full">
                      ...
                      <router-link :to="`/profil/${official.slug}`" :class="`inline-flex items-center justify-center w-full ${group.btnBg} text-white font-black text-xs py-4 rounded-2xl transition-all duration-500 uppercase tracking-widest gap-2 shadow-lg ${group.btnShadow}`">
