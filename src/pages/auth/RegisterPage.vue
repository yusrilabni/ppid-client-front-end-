<template>
  <div class="min-h-screen flex items-center justify-center bg-gray-50 px-4 py-12">
    <div class="w-full max-w-md">
      ...
      <!-- Back to Login -->
      <router-link to="/login" class="absolute top-4 left-4 sm:top-8 sm:left-8 text-gray-400 hover:text-blue-600 transition-colors flex items-center text-xs font-bold uppercase tracking-widest">
        <i class="fas fa-arrow-left w-3 h-3 mr-2"></i> Kembali
      </router-link>
