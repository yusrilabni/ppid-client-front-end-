...
export const getBreadcrumbs = {
  ...
  permohonanPage: () => [home, { title: 'Transparansi', icon: 'fas fa-chart-bar' }, { title: 'Laporan Permohonan Informasi', url: '/laporan/permohonan', icon: 'fas fa-file-signature' }, { title: 'Formulir Permohonan', icon: 'fas fa-edit' }],
  ...
  laporanPermohonanSayaDetail: () => [home, { title: 'Transparansi', icon: 'fas fa-chart-bar' }, { title: 'Laporan Permohonan Informasi', url: '/laporan/permohonan', icon: 'fas fa-file-signature' }, { title: 'Detail', icon: 'fas fa-info-circle' }],
